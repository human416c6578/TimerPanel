...
<div class="relative flex min-h-screen flex-col overflow-hidden bg-gray-50 py-6 sm:py-12">
    ...
    <div class="relative flex min-h-screen overflow-hidden flex-col xl:flex-row items-center xl:items-start xl:justify-around justify-start space-y-8 xl:space-y-0">
        <div class="p-4 relative flex flex-col sm:flex-row justify-around overflow-hidden bg-gray-900 dark:bg-gray-900 rounded xl:w-fit w-fit z-10 space-y-2 sm:space-x-8">
                <!-- Profile -->
                <div class="flex flex-col">
                    <img class="self-center p-1 w-40 h-40 rounded bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%" src="<?php echo $playerSteam["avatarfull"] ?>"/>
                    ...
                    <div class="flex flex-col">
                        <span class="self-center m-2 py-1 px-2 font-semibold text-md bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% rounded ring-1 ring-cyan-500"><?php echo$playerData["steamid"]?></span>
                ...
                <div class="flex flex-col text-md font-semibold text-white dark:text-white">
                    <div class="flex flex-row justify-between">
                        <span class="self-center m-2 py-1 px-2 font-semibold text-md bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% rounded ring-1 ring-cyan-500">Rank</span>
                        <span class="m-2 py-1 px-4 bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% rounded"><?php echo $playerData["rank"] ?></span>
                    </div>
                    <div class="flex flex-row justify-between">
                        <span class="self-center m-2 py-1 px-2 font-semibold text-md bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% rounded ring-1 ring-cyan-500">Score</span>
                        <span class="m-2 py-1 px-4 bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% rounded"><?php echo $playerData["score"] ?></span>
                    </div>
                    <div class="flex flex-row justify-between">
                        <span class="self-center m-2 py-1 px-2 font-semibold text-md bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% rounded ring-1 ring-cyan-500">Runs</span>
                        <span class="m-2 py-1 px-4 bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% rounded"><?php echo $playerData["runs"] ?></span>
                    </div>
                    <!--
                    <div class="flex flex-row justify-between">
                    ...
                    -->
                    <div class="flex flex-row justify-between">
                        <span class="self-center m-2 py-1 px-2 font-semibold text-md bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% rounded ring-1 ring-cyan-500">Time</span>
                        <span class="m-2 py-1 px-4 bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% rounded"><?php echo $playerData["time"]."h" ?></span>
                    </div>
                    <div class="flex flex-row justify-center space-x-6 mt-6 text-md font-semibold text-white dark:text-white">
        ...
        <div class="relative flex flex-col justify-center overflow-hidden bg-gradient-to-r from-blue-500 to-red-500 rounded h-2/6 xl:w-7/12 w-full py-6 xl:px-6 px-0 z-10">
            <div id="button-container" class="self-center w-fit flex flex-row justify-center space-x-2">
                <button id="records-button" onclick="displayRecords()" class="px-4 text-slate-100 dark:text-slate-100 font-semibold text-xl px-2 duration-150 rounded hover:text-black hover:bg-white bg-slate-800">Records</button>
                <button id="medals-button" onclick="displayMedals()" class="px-4 text-slate-100 dark:text-slate-100 font-semibold text-xl px-2 duration-150 rounded hover:text-black hover:bg-white bg-slate-800">Medals</button>
            </div>
                    ...
                    <div class="relative rounded-xl overflow-auto">
                        <div class="shadow-sm overflow-hidden my-4">
                            <table id="records-table" class="category-table border-collapse table-fixed w-full text-sm">
                                <thead>
                                <tr>
                                    <th class="w-20 overflow-hidden border-b border-slate-600 dark:border-slate-600 xl:text-sm text-xs xl:text-medium p-4 pr-4 pt-2 pb-3 text-slate-200 dark:text-slate-200 text-left">
                                        <div class="relative flex flex-row justify-start">
                                            Rank
                                            <svg id="sortRank" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 hover:stroke-blue-500 cursor-pointer duration-150">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />
                                            </svg>

                                        </div>
                                    </th>
                                    <th class="w-1/4 overflow-hidden border-b border-slate-600 dark:border-slate-600 xl:text-sm text-xs xl:text-medium p-4 pr-4 pt-2 pb-3 text-slate-200 dark:text-slate-200 text-left">
                                        <div class="flex flex-row justify-start">
                                            Map
                                            <svg id="sortMap" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 hover:stroke-blue-500 cursor-pointer duration-150">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />
                                            </svg>
                                        </div>
                                    </th>
                                    <th class="border-b border-slate-600 dark:border-slate-600 xl:text-sm text-xs xl:text-medium p-4 pr-4 pt-2 pb-3 text-slate-200 dark:text-slate-200 text-left">
                                        <div class="flex flex-row justify-start">
                                            Category
                                            <svg id="sortCategory" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 hover:stroke-blue-500 cursor-pointer duration-150">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />
                                            </svg>
                                        </div>
                                    </th>
                                    <th class="border-b border-slate-600 dark:border-slate-600 xl:text-sm text-xs xl:text-medium p-4 pr-4 pt-2 pb-3 text-slate-200 dark:text-slate-200 text-left">
                                        <div class="flex flex-row justify-start">
                                            Time
                                            <svg id="sortTime" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 hover:stroke-blue-500 cursor-pointer duration-150">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />
                                            </svg>
                                        </div>
                                    </th>
                                    <th class="border-b border-slate-600 dark:border-slate-600 xl:text-sm text-xs xl:text-medium p-4 pr-4 pt-2 pb-3 text-slate-200 dark:text-slate-200 text-left xl:table-cell hidden">
                                        <div class="flex flex-row justify-start">
                                            Record Date
                                            <svg id="sortDate" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 hover:stroke-blue-500 cursor-pointer duration-150">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />
                                            </svg>
                                        </div>
                                    </th>
                                    <th class="border-b border-slate-600 dark:border-slate-600 xl:text-sm text-xs xl:text-medium p-4 pr-4 pt-2 pb-3 text-slate-200 dark:text-slate-200 text-left xl:table-cell hidden">
                                        <div class="flex flex-row justify-start">
                                            Start Speed
                                            <svg id="sortSpeed" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 hover:stroke-blue-500 cursor-pointer duration-150">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />
                                            </svg>
                                        </div>
                                    </th>
                            ...
                            <div class="flex flex-col items-center pt-2">
                                ...
                                Showing <span id="startEntry" class="font-semibold text-gray-900 dark:text-white">1</span> to <span id="endEntry" class="font-semibold text-gray-900 dark:text-white">10</span> of <span id="totalEntries" class="font-semibold text-gray-900 dark:text-white">100</span> Entries
                             </span>
                                <!-- Buttons -->
                                <div class="inline-flex mt-2 xs:mt-0">
                                    <button id="prevPage" class="flex items-center justify-center px-3 h-8 text-sm font-medium text-white bg-gray-800 rounded-l hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                        Prev
                                    </button>
                                    <button id="nextPage" class="flex items-center justify-center px-3 h-8 text-sm font-medium text-white bg-gray-800 border-0 border-l border-gray-700 rounded-r hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                        Next
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="relative rounded-xl overflow-auto">
                        <div class="shadow-sm overflow-hidden my-4">
                            <table id="records-table" class="category-table border-collapse table-fixed w-full text-sm">
                                ...
                                <tr>
                                    ...
                                    <th class="border-b border-slate-600 dark:border-slate-600 xl:text-sm text-xs xl:text-medium p-4 pr-4 pt-2 pb-3 text-slate-200 dark:text-slate-200 text-left">
                                        <div class="flex flex-row justify-start">
                                            Bronze
                                            <svg id="sortBronze" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 hover:stroke-blue-500 cursor-pointer duration-150">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />
                                            </svg>
                                        </div>
                                    </th>
                                    <th class="border-b border-slate-600 dark:border-slate-600 xl:text-sm text-xs xl:text-medium p-4 pr-4 pt-2 pb-3 text-slate-200 dark:text-slate-200 text-left">
                                        <div class="flex flex-row justify-start">
                                            Silver
                                            <svg id="sortSilver" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 hover:stroke-blue-500 cursor-pointer duration-150">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />
                                            </svg>
                                        </div>
                                    </th>
                                    <th class="border-b border-slate-600 dark:border-slate-600 xl:text-sm text-xs xl:text-medium p-4 pr-4 pt-2 pb-3 text-slate-200 dark:text-slate-200 text-left">
                                        <div class="flex flex-row justify-start">
                                            Gold
                                            <svg id="sortGold" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 hover:stroke-blue-500 cursor-pointer duration-150">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />
                                            </svg>
                                        </div>
                                    </th>
                            ...
                            <div class="flex flex-col items-center pt-2">
                                <!-- Help text -->
                                <span class="text-sm text-gray-700 dark:text-gray-400">
                                Showing <span id="startMedalsEntry" class="font-semibold text-gray-900 dark:text-white">1</span> to <span id="endMedalsEntry" class="font-semibold text-gray-900 dark:text-white">10</span> of <span id="totalMedalsEntries" class="font-semibold text-gray-900 dark:text-white">100</span> Entries
                             </span>
                                <!-- Buttons -->
                                <div class="inline-flex mt-2 xs:mt-0">
                                    <button id="prevMedalsPage" class="flex items-center justify-center px-3 h-8 text-sm font-medium text-white bg-gray-800 rounded-l hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                        Prev
                                    </button>
                                    <button id="nextMedalsPage" class="flex items-center justify-center px-3 h-8 text-sm font-medium text-white bg-gray-800 border-0 border-l border-gray-700 rounded-r hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                        Next
                                    </button>
                                </div>
                            </div>
    ...
    function recordsTable()
    {
        ...
        function applyFilters() {
            filteredRecords = playerRecords.filter(record => {
                const mapMatch = mapSearch.value.length?record.map.toLowerCase().includes(mapSearch.value.toLowerCase()):true;
                const categoryMatch = categorySearch.value.length?record.category.toLowerCase().includes(categorySearch.value.toLowerCase()):true;
        ...
        function toggleArrowPath(element) {
            if (sortCriteria.order === 'asc') {
                element.innerHTML = '<path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />'; // Change to ascending arrow
            } else {
                element.innerHTML = '<path stroke-linecap="round" stroke-linejoin="round" d="M12 19.5v-15m0 0l-6.75 6.75M12 4.5l6.75 6.75" />'; // Change to descending arrow
            }
        }
        // Function to reset arrow paths for all sorting headers
        function resetArrowPaths() {
            sortRankSpan.innerHTML =        '<path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />';
            sortMapSpan.innerHTML =         '<path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />';
            sortCategorySpan.innerHTML =    '<path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />';
            sortTimeSpan.innerHTML =        '<path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />';
            sortDateSpan.innerHTML =        '<path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />';
            sortSpeedSpan.innerHTML =       '<path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />';
        }
...
<script>
    function medalsTable()
    {
        ...
        // Function to reset arrow paths for all sorting headers
        function resetArrowPaths() {
            sortBronzeSpan.innerHTML =        '<path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />';
            sortSilverSpan.innerHTML =         '<path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />';
            sortGoldSpan.innerHTML =    '<path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />';
        }
