...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($postData->name) && isset($postData->steamid) && isset($postData->category) && isset($postData->map)) {
        // Call the get_records function with the search criteria
        $records = $db->get_records($postData->name, $postData->steamid, $postData->category, $postData->map);
